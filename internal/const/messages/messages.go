...
Посмотреть инструкцию можно, набрав команду /info`
	...
	InfoMessage5   string = "5. При добавлении записей через опцию 'Поделиться',\nесли в сообщении написать восклицательный знак и название папки (!название), то запись будеть добавлена в эту папку. Если этой папки не существоует, она создастся автоматически."
)
